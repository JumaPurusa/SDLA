...
public class EncryptedImagesAdapter extends RecyclerView.Adapter<EncryptedImagesAdapter.MyViewHolder>{

    private Context context;
    private List<ImageFile> listOfEncryptedImage;
    ...
    public EncryptedImagesAdapter(Context context){
        this.context = context;
        mSelectedItemIds = new SparseBooleanArray();
    }

    public void addListOfEncryptedDoc(List<ImageFile> list){
        this.listOfEncryptedImage = list;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Glide.with(context)
                ...
                .into(holder.encryptedImage);

        holder.fileName.setText(listOfEncryptedImage.get(position).getName());

        holder.fileSize.setText(listOfEncryptedImage.get(position).getSize());
    ...
    public int getItemCount() {
        return listOfEncryptedImage.size();
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            encryptedImage = itemView.findViewById(R.id.encrypted_file_image);
