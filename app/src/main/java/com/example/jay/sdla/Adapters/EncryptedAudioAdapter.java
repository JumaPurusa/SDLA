...
public class EncryptedAudioAdapter extends RecyclerView.Adapter<EncryptedAudioAdapter.MyViewHolder>{
    ...
    public EncryptedAudioAdapter(Context context){
        this.context = context;
        mSelectedItemIds = new SparseBooleanArray();
    }

    public void addListOfEncryptedDoc(List<SongInfo> list){
        this.listOfEncryptedAudios = list;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.fileName.setText(listOfEncryptedAudios.get(position).getName());

        holder.fileSize.setText(listOfEncryptedAudios.get(position).getSize());
    ...
    public int getItemCount() {
        return listOfEncryptedAudios.size();
    }
